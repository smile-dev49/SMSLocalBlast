...
Optional: Run `sql/005_licenses_and_global_settings.sql` for licensing. Run `sql/006_claim_with_device.sql` for multi-device tracking. Run `sql/007_api_keys.sql` for API key manager.
