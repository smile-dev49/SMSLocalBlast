-- Prisma maps @@index([deviceId, createdAt(sort: Desc)]) to DeviceHeartbeat_deviceId_createdAt_idx.
-- devices migration creates DeviceHeartbeat_deviceId_createdAt_desc_idx until renamed here.
DO $$
BEGIN
  IF EXISTS (
    SELECT 1
